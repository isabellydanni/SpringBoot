...
import com.ensino.minhaEscola.repository.TurmaRepository;
...
public class TurmaController {
	...
	{
		return ResponseEntity.status(HttpStatus.CREATED).body(repo.save(turma));
	}
	
	@PutMapping
	public ResponseEntity<Turma> put(@RequestBody Turma turma)
	{
		return ResponseEntity.status(HttpStatus.OK).body(repo.save(turma));
	}
